...
import Audit, { getAudit, setAudit } from './base/audit';
...
import registerPlugin, { plugins, cleanupPlugins } from './public/plugins';
...
import getEnvironmentData from './reporters/helpers/get-environment-data';
...
Object.defineProperties(axe, {
  ...
  _tree: {
    get() {
      return cache.get('vTree');
    },
    set(value) {
      cache.set('vTree', value);
    }
  },
  _selectorData: {
    get() {
      return cache.get('selectorData');
    },
    set(value) {
      cache.set('selectorData', value);
    }
  },
  _selectCache: {
    get() {
      return cache.get('selectCache');
    },
    set(value) {
      cache.set('selectCache', value);
    }
  }
});
